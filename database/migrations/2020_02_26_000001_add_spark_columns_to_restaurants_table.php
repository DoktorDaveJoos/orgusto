...
class AddSparkColumnsToRestaurantsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('restaurants', function (Blueprint $table) {
            ...
            $table
                ->text('extra_billing_information')
                ->nullable()
            ...
            $table
                ...
                ->after('billing_city');
            $table
                ->string('billing_postal_code', 25)
                ->nullable()
                ->after('billing_state');
            $table
                ->string('billing_country', 2)
                ->nullable()
